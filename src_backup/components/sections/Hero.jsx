                ...
                <div className="flex flex-col items-start gap-8">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-6 items-center">
                            ...
                            >
                                <div className="absolute inset-0 bg-accent-blue translate-y-[101%] group-hover:translate-y-0 transition-transform duration-500" />
                                <span className="relative z-10 group-hover:text-white transition-colors">START A PROJECT</span>
                                <FiArrowDownRight className="relative z-10 text-xl group-hover:text-white transition-colors" />
                            </motion.button>

                            <button className="text-slate-400 hover:text-white font-mono text-sm tracking-widest transition-colors flex items-center gap-2 border-b border-transparent hover:border-white/20 pb-1">
