...
import { SiJava, SiSpringboot, SiHibernate, SiReact, SiJavascript, SiTailwindcss, SiMysql, SiGit, SiDocker } from 'react-icons/si'
...
const SkillIcon = ({ icon: Icon, name, delay }) => (
    <motion.div
        ...
        className="flex flex-col items-center gap-4 p-8 glass-card rounded-[2rem] group"
    >
        <div className="text-5xl text-slate-500 group-hover:text-accent-blue transition-colors duration-500">
            <Icon />
        </div>
...
const Skills = () => {
    ...
    return (
        <section id="status" className="section-padding bg-slate-900/5 overflow-hidden">
                        ...
                        <div className="glass-panel p-8 rounded-3xl inline-block">
                            <div className="flex items-center gap-8">
                                <div>
                                    ...
                                    <div className="text-white font-bold">LATEST REACT</div>
                                </div>
                                <div className="w-[1px] h-8 bg-white/10" />
                                <div>
                                    <div className="text-sm font-mono text-slate-500 mb-1">BACKEND</div>
                                    <div className="text-white font-bold">SPRING ECOSYSTEM</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-accent-blue/5 rounded-full blur-[200px] -z-10" />
        </section>
    )
}
